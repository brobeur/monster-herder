...
var runAnimationTitle 		: String = "run";
...
function Start () {
	if(!player)
		print("WARNING: ATTACH PLAYER TO MONSTER!");
	...
	runAnimationTitle = "run";
	painAnimationTitle = "gothit";
	attackAnimationTitle = "attack";
	...
	animation[painAnimationTitle].speed = 1.5;
...
function FlashlightScare(awayVector : Vector3) {
	...
	if(behavior == CHASING || behavior == IDLERUN)
	{
		...
		animation.Play(painAnimationTitle);
